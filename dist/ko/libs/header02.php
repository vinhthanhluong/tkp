  ...
  <div class="inHeader">
    <div id="logo">
      <?php if ($thisPageName == 'ishinoya') { ?>
        <h1>
          <a class="logo-link" href="<?php echo APP_URL_KO ?>guide/ishinoya/">
      ...
      <?php } ?>
      <a class="home-link" href="<?php echo APP_URL_KO; ?>">
    ...
    <div class="layerMenu">
      <div class="inLayer">
        ...
        <a class="gLogo sp" href="<?php echo APP_URL_KO ?>guide/ishinoya/">
          <img src="<?php echo APP_ASSETS ?>img/common/logo02_black.svg" alt="ISHINOYA 別府 / 石のや 別府">
        </a>
        <ul class="gNavi">
          <li class="gNavi-item"><a href="<?php echo APP_URL_KO ?>guide/ishinoya/rooms/"><span>객실</span></a></li>
          <li class="gNavi-item"><a href="<?php echo APP_URL_KO ?>guide/ishinoya/spa/"><span>온천・모래찜질</span></a></li>
          <li class="gNavi-item"><a href="<?php echo APP_URL_KO ?>guide/ishinoya/cuisine/"><span>식사</span></a></li>
          <li class="gNavi-item"><a href="<?php echo APP_URL_KO ?>guide/ishinoya/contact/"><span>문의하기</span></a></li>
        </ul>
        <div class="gLang pc">
