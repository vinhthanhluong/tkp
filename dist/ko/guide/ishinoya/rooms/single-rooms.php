...
$post_id = $current_id;
$ttlpost = get_field('title_ko', $post_id) ?: get_the_title($post_id);
...
<body id="rooms-single" class="rooms-single ko">
      ...
      <div class="inner1170">
        <div class="c-breadcrumb is-breadcrumb-dis aos-init" data-aos="fade-up">
          <ul>
            ...
            <li><a href="<?php echo APP_URL_KO; ?>guide/ishinoya/rooms/">객실</a></li>
