...
?>
  ...
  <body id="ishinoya-form" class="ishinoya-form page-form form-confirm ko">
    ...
    <main id="wrap02">
      <div class="sec-formconfirm">
        <div class="inner1170">
          ...
          <div class="form-step">
            <img class="pc" src="<?php echo createSVG(518, 150) ?>" data-src="<?php echo APP_ASSETS; ?>img/ishinoya/contact/form/img_step02_ko.png" rel="js-lazy" width="518" height="150" alt="内容確認">
            <img class="sp" src="<?php echo createSVG(327, 95) ?>" data-src="<?php echo APP_ASSETS; ?>img/ishinoya/contact/form/img_step02_sp_ko.png" rel="js-lazy" width="327" height="95" alt="内容確認">
          </div>
          <p class="short-desc">입력하신 내용을 확인해 주십시오.<br class="pc">입력 내용을 확인하신 후 보내기 버튼을 눌러 주십시오.</p>
          ...
          <div class="form-inner">
            <form method="post" class="confirmform" action="../complete/?g=<?php echo $gtime ?>" name="confirmform" id="confirmform">
              ...
              <div class="list-btn">
                <div class="btn-back">
                  <p rel="js-back" class="txt-back"><span>입력한 내용 변경하기</span></p>
                </div>
                <div class="btn-send">
                  <?php if (defined('GOOGLE_RECAPTCHA_KEY_API') && GOOGLE_RECAPTCHA_KEY_API != '') { ?>
                    <button name="actionFlag" value="<?php echo sanitize_form_value('send') ?>" class="g-recaptcha" id="btnSend" data-size="invisible" data-sitekey="<?php echo GOOGLE_RECAPTCHA_KEY_API ?>" data-callback="onSubmit"><span>이 내용으로 보내기</span></button>
                  <?php } else { ?>
                    <button id="btnSend"><span>이 내용으로 보내기</span></button>
                  <?php } ?>
