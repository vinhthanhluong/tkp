 ...
 **/
include_once(APP_PATH_KO . 'guide/ishinoya/contact/form/confirm/index.php');
...
-----END RSA PRIVATE KEY-----';
  ...
  header("Location: " . APP_URL_KO . "guide/ishinoya/contact/form/complete/");
  exit;
}
...
?>
<meta http-equiv="refresh" content="15; url=<?php echo APP_URL_KO ?>guide/ishinoya/">
...
<body id="ishinoya-form" class="ishinoya-form page-form form-thanks ko">
  ...
  <main id="wrap02">
    <div class="sec-formcomplete">
      <div class="inner1170">
        ...
        <div class="form-step">
          <img class="pc" src="<?php echo createSVG(518, 150) ?>" data-src="<?php echo APP_ASSETS; ?>img/ishinoya/contact/form/img_step03_ko.png" rel="js-lazy" width="518" height="150" alt="送信完了">
          <img class="sp" src="<?php echo createSVG(327, 95) ?>" data-src="<?php echo APP_ASSETS; ?>img/ishinoya/contact/form/img_step03_sp_ko.png" rel="js-lazy" width="327" height="95" alt="送信完了">
        </div>
        <div class="form-inner">
          <div class="thanks-main">
            ...
            <p class="thanks-main__txt02">일정한 시간이 지나도 이메일을 못 받으시는 경우 입력하신 이메일이 잘못 입력 되었거나 시스템 오류,스팸 메일 폴더에 보관되어 있을 수 있습니다. 그럴 경우 죄송하지만 한 번 더 문의하기 란에서 문의를 주시거나 전화로 직접 연락 주시기 바랍니다.</p>
