...
$food_list = get_field('food_list_ko', $post_id);
$file_repeater = get_field('file_repeater_ko', $post_id);
...
<body id="restaurant" class="restaurant ko">
  ...
  <main id="wrap">
      ...
      <?php if (!empty($food_list) || !empty($file_repeater)) { ?>
        <div class="inner1170">
          <h2 class="c-ttl02 aos-init" data-aos="fade-up">
            <span class="c-ttl02__jp">메뉴</span>
      ...
      <section class="c-news-block" rel="js-lazy" data-bgpc="<?php echo APP_ASSETS; ?>img/common/news_bg.jpg" data-bgsp="<?php echo APP_ASSETS; ?>img/common/news_bg_sp.jpg">
        <div class="inner1170">
          <h2 class="c-ttl02 is-white aos-init" data-aos="fade-up">
            <span class="c-ttl02__jp">뉴스</span>
          ...
          <div class="aos-init" data-aos="fade-up">
            <a href="<?php echo insertLangInUrl(get_term_link($restaurantTermId, 'newscat'), 'newscat', 'ko'); ?>" class="c-btn01 is-center">
              <i class="arr01"></i>
              <span>더 보기</span>
              <i class="arr02"></i>
            </a>
    ...
    <div class="sec-instagram">
      <div class="instagram-inner">
        <div class="t-wcm01">
          <h2 class="c-ttl02 aos-init" data-aos="fade-up">
            <span class="c-ttl02__jp">공식 인스타그램</span>
