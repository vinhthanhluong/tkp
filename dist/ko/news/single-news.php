...
$sg_title   = get_field('title_ko', $sg_id) ?: get_the_title($sg_id);
...
<body id="news-single" class="news-single ko">
  ...
  <main id="wrap">
    <div class="c-breadcrumb aos-init" data-aos="fade-up">
      <ul>
        ...
        <li><a href="<?php echo APP_URL_KO; ?>news/">시설안내</a></li>
        ...
        <div class="box-meta aos-init" data-aos="fade-up">
          ...
          <?php if (!empty($sg_terms)) {
            foreach ($sg_terms as $term) {
              $cat_id = $term->term_id;
              $cat_name = get_field('cat_name_ko', 'newscat' . '_' . $cat_id) ?: $term->name;
      ...
      <div class="article-block">
        ...
        <div class="sg-share aos-init" data-aos="fade-up">
          <div class="share-inner">
            ...
            <a class="share__link" target="_blank" href="https://twitter.com/share?url=<?php echo APP_URL_KO; ?>news/<?php echo urlencode(strip_tags(get_post_field('post_name', $sg_id))); ?>">
              <img width="31" height="30" src="<?php echo createSVG(31, 30); ?>" data-src="<?php echo APP_ASSETS; ?>img/common/ico_x.svg" rel="js-lazy" alt="">
            </a>
            <a class="share__link pc" target="_blank" href="https://line.me/R/msg/text/?<?php echo urlencode(get_the_title($sg_id)); ?>%0D%0A<?php echo urlencode(insertLangInUrl(get_the_permalink($sg_id), 'news', 'ko')); ?>">
              <img width="31" height="30" src="<?php echo createSVG(31, 30); ?>" data-src="<?php echo APP_ASSETS; ?>img/common/ico_line.svg" rel="js-lazy" alt="">
            </a>
            <a class="share__link sp" target="_blank" href="line://msg/text/<?php echo urlencode(get_the_title($sg_id)); ?>%0D%0A<?php echo urlencode(insertLangInUrl(get_the_permalink($sg_id), 'news', 'ko')); ?>">
              <img width="31" height="30" src="<?php echo createSVG(31, 30); ?>" data-src="<?php echo APP_ASSETS; ?>img/common/ico_line.svg" rel="js-lazy" alt="">
            </a>
            <script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script>
            <a class="share__link" target="_blank" href="http://www.facebook.com/sharer.php?u=<?php echo insertLangInUrl(get_the_permalink($sg_id), 'news', 'ko'); ?>">
        ...
        if (isset($ids[$thisindex + 1])) {
          ...
          $prev_link = insertLangInUrl($prev_link, 'news', 'ko');
          $prev_ttl = get_field('title_ko', $previd) ?: get_the_title($previd);
        ...
        if (isset($ids[$thisindex - 1])) {
          ...
          $next_link = insertLangInUrl($next_link, 'news', 'ko');
          $next_ttl = get_field('title_ko', $nextid) ?: get_the_title($nextid);
        ...
        <div class="mod-pagination">
          ...
          <a href="<?php echo APP_URL_KO ?>news/" class="c-btn01 is-cover">
            <i class="arr01"></i>
            <span>목록으로</span>
            <i class="arr02"></i>
          </a>
