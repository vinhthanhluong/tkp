...
$titlepage = $sg_title_strip . '｜最新动态与活动｜SHONIN PARK';
      ...
      <div class="article-block">
        ...
        <div class="sg-share aos-init" data-aos="fade-up">
          <div class="share-inner">
            ...
            <a class="share__link" target="_blank" href="https://twitter.com/share?url=<?php echo APP_URL_CN; ?>news/<?php echo urlencode(strip_tags(get_post_field('post_name', $sg_id))); ?>">
