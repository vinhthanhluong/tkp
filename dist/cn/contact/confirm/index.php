...
ob_start();
if (empty($_POST['actionFlag']) && empty($_SESSION['statusFlag']) && (!isset($_POST['_csrf']) || !verify_csrf_token(sanitize_form_value($_POST['_csrf'])))) header('location: ' . APP_URL_CN);
...
?>
  ...
  <body id="contact" class="contact page-form form-confirm cn">
    ...
    <main id="wrap">
      ...
      <div class="sec-form c-bg-wave01">
        <div class="img-step">
          <img class="pc" src="<?php echo createSVG(520, 140) ?>" data-src="<?php echo APP_ASSETS; ?>img/contact/img_step02_cn.png" rel="js-lazy" width="520" height="140" alt="内容確認">
          <img class="sp" src="<?php echo createSVG(327, 88) ?>" data-src="<?php echo APP_ASSETS; ?>img/contact/img_step02_sp_cn.png" rel="js-lazy" width="327" height="88" alt="内容確認">
        </div>
        <form method="post" class="confirmform" action="../complete/?g=<?php echo $gtime ?>" name="confirmform" id="confirmform">
          <div class="form-block">
            ...
            <div class="list-btn">
              <div class="btn-back">
                <p rel="js-back" class="txt-back">修改填写内容</p>
              </div>
              <div class="btn-send">
                <?php if (defined('GOOGLE_RECAPTCHA_KEY_API') && GOOGLE_RECAPTCHA_KEY_API != '') { ?>
                  <button name="actionFlag" value="<?php echo sanitize_form_value('send') ?>" class="g-recaptcha c-btn02" id="btnSend" data-size="invisible" data-sitekey="<?php echo GOOGLE_RECAPTCHA_KEY_API ?>" data-callback="onSubmit"><span>发送以上内容</span></button>
                <?php } else { ?>
                  <button class="c-btn02" id="btnSend"><span>发送以上内容</span></button>
                <?php } ?>
