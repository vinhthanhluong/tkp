...
<body id="contact" class="contact page-form">
  ...
  <main id="wrap">
    ...
    <p class="short-desc">お問い合わせ前に<a href="<?php echo APP_URL_EN ?>info#info04">よくあるご質問</a>をご確認い<br class="sp">ただいた上で、<br class="pc">お問い合わせフォームへのご入<br class="sp">力をお願いいたします。</p>
