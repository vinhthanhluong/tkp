    ...
    <div class="layerMenu">
      <div class="inLayer">
        ...
        <ul class="gReservat">
          ...
          <li class="gReservat-item">
            <a href="https://reserve.489ban.net/client/ishinoya-beppu/1/plan/stay" target="_blank" rel="noopener" class="c-btn01 is-center">
              <i class="arr01"></i>
              <span>预约住宿度假屋</span>
              <i class="arr02"></i>
            </a>
        ...
        <div class="gOfficial-ctn">
          ...
          <ul class="gOfficial-lang sp">
            ...
            <li class="item is-active"><a href="<?php echo APP_URL_CN ?><?php echo $curr_path; ?>">中文簡体</a></li>
          </ul>
        </div>
        ...
        <div class="gResert-item hasSub">
          ...
          <div class="navSub">
            <ul class="navSub-lst">
              ...
              <li class="item">
                <a href="https://reserve.489ban.net/client/ishinoya-beppu/1/plan/stay" target="_blank" rel="noopener" class="c-btn01">
                  <i class="arr01"></i>
                  <span>预约住宿度假屋</span>
                  <i class="arr02"></i>
                </a>
