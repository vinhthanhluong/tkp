  ...
  <div class="inHeader">
    <div id="logo">
      <?php if ($thisPageName == 'ishinoya') { ?>
        <h1>
          <a class="logo-link" href="<?php echo APP_URL_CN ?>guide/ishinoya/">
      ...
      <?php } ?>
      <a class="home-link" href="<?php echo APP_URL_CN; ?>">
    ...
    <div class="layerMenu">
      <div class="inLayer">
        ...
        <a class="gLogo sp" href="<?php echo APP_URL_CN ?>guide/ishinoya/">
          <img src="<?php echo APP_ASSETS ?>img/common/logo02_black.svg" alt="ISHINOYA 別府 / 石のや 別府">
        </a>
        <ul class="gNavi">
          <li class="gNavi-item"><a href="<?php echo APP_URL_CN ?>guide/ishinoya/rooms/"><span>客房</span></a></li>
          <li class="gNavi-item"><a href="<?php echo APP_URL_CN ?>guide/ishinoya/spa/"><span>温泉和沙浴</span></a></li>
          <li class="gNavi-item"><a href="<?php echo APP_URL_CN ?>guide/ishinoya/cuisine/"><span>餐饮</span></a></li>
          <li class="gNavi-item"><a href="<?php echo APP_URL_CN ?>guide/ishinoya/contact/"><span>咨询</span></a></li>
        </ul>
        <div class="gLang pc">
        ...
        <ul class="gBtn">
          <li class="gBtn-item">
            <a href="https://reserve.489ban.net/client/ishinoya-beppu/1/booked/login" target="_blank" rel="noopener nofollow"><span>预约确认</span></a>
          </li>
          <li class="gBtn-item">
            <a href="https://reserve.489ban.net/client/ishinoya-beppu/1/plan/stay" target="_blank" rel="noopener nofollow"><span>预约住宿</span></a>
          </li>
        </ul>
        <ul class="gLangSp sp">
          ...
          <li class="gLangSp-item is-active"><a href="<?php echo APP_URL_CN ?><?php echo $curr_path; ?>">中文簡体</a></li>
        </ul>
        <a class="gLinkSp sp" href="<?php echo APP_URL_CN; ?>">
          <span class="txt">SHONIN PARK</span>
        </a>
