...
<header class="header03">
  <div class="header-inner">
    <a class="header-logo" href="<?php echo APP_URL_CN ?>"><img src="<?php echo createSVG(175, 55); ?>" data-src="<?php echo APP_ASSETS ?>img/common/logo.svg" rel="js-lazy" width="175" height="55" alt="logo"></a>
    <nav class="header-info">
      <ul class="header-menu pc js-header-menu-drop">
        <li class="has-sub">
          <a class="menu-link c-txt-hover" href="<?php echo APP_URL_CN ?>guide/">
            <span class="txt-wrap">
              <span class="txt-default">设施指南</span>
              <span class="txt-on">设施指南</span>
            </span>
          </a>
          <div class="header-mega">
            <ul class="menu-list">
              <li><a href="<?php echo APP_URL_CN ?>guide/spa/">别府海滨沙浴</a></li>
              <li><a href="<?php echo APP_URL_CN ?>guide/shop/">商饮区</a></li>
              <li><a href="<?php echo APP_URL_CN ?>guide/restaurant/">餐厅</a></li>
              <li><a href="<?php echo APP_URL_CN ?>guide/ishinoya/">住宿度假屋</a></li>
            </ul>
          </div>
        </li>
        <li>
          <a class="menu-link c-txt-hover" href="<?php echo APP_URL_CN ?>ways/">
            <span class="txt-wrap">
      ...
      <a class="header-btn c-txt-hover pc" href="https://www.asoview.com/channel/tickets/KfG8g2DPlR/" target="_blank" rel="noopener nofollow">
        <span class="txt-wrap">
          <span class="txt-default">预约沙浴和温泉</span>
          <span class="txt-on">预约沙浴和温泉</span>
        </span>
      </a>
        ...
        <div class="navigation-inner">
          ...
          <div class="navigation-row">
            <ul class="navigation-menu fs">
              <li class="is-col01"><a href="<?php echo APP_URL_CN ?>guide/">设施指南</a></li>
              <li class="is-col is-col01 is-order01"><a href="<?php echo APP_URL_CN ?>ways/">游玩指南</a></li>
              <li class="is-col02 is-order02"><a href="<?php echo APP_URL_CN ?>news/">最新动态</a></li>
          ...
          <div class="navigation-row">
            ...
            <ul class="language-list sp">
              ...
              <li><a href="<?php echo APP_URL_KO ?><?php echo $curr_path; ?>">한국어</a></li>
              <li><a class="is-active" href="<?php echo APP_URL_CN ?><?php echo $curr_path; ?>">中文簡体</a></li>
            </ul>
          </div>
        </div>
      </div>
