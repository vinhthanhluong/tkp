...
<body id="ishinoya-rooms" class="ishinoya-rooms cn">
        ...
        <div class="inner">
          <ul class="anchor-list aos-init" data-aos="fade-up">
            ...
            while ($rooms_post_all->have_posts()) {
              ...
              $rooms_id = get_the_ID();
              $rooms_ttl = get_field('title_cn', $rooms_id) ?: get_the_title($rooms_id);
              $room_info = get_field('room_info_cn', $rooms_id);
                  ...
                  <div class="anchor-inner">
                    ...
                    <ul class="c-txt-list">
                      ...
                      <?php if ($room_bath == 'inside') { ?>
                        <li class="icn icn03">客房内温泉</li>
                      <?php } else if ($room_bath == 'outside') { ?>
                        <li class="icn icn04">附带露天温泉浴池</li>
                      <?php } ?>
                    </ul>
                  </div>
                </a>
          ...
          <ul class="rooms-list">
            ...
            while ($rooms_post_all->have_posts()) {
              ...
              $rooms_id = get_the_ID();
              $rooms_ttl = get_field('title_cn', $rooms_id) ?: get_the_title($rooms_id);
              $rooms_link = insertLangInUrl(get_the_permalink($rooms_id), 'guide', 'cn');
              ...
              $room_desc = get_field('room_desc_cn', $rooms_id);
            ...
            ?>
              <li class="rooms-item aos-init" data-aos="fade-up" id="anchor<?php echo $rooms_id; ?>">
                ...
                <div class="rooms-info">
                  ...
                  <a class="c-btn04" href="<?php echo $rooms_link; ?>"><span>了解更多</span></a>
                </div>
              </li>
            <?php } ?>
          </ul>
