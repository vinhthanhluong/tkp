...
$shop_list = get_field('shop_list_cn', $post_id);
$shop_list_name = [];
if (!empty($shop_list)) {
  $is_all_empty = true;
      ...
      <div class="inner1170">
        ...
        <?php if (!$is_all_empty) { ?>
          ...
          <div class="map-block aos-init" data-aos="fade-up">
            <img class="map-bg pc" src="<?php echo createSVG(1170, 577); ?>" data-src="<?php echo APP_ASSETS ?>img/guide/shop/map_shop.svg" rel="js-lazy" width="1170" height="577" alt="商饮区域地图">
            <img class="map-bg sp" src="<?php echo createSVG(327, 162); ?>" data-src="<?php echo APP_ASSETS ?>img/guide/shop/map_shop_sp.png" rel="js-lazy" width="327" height="162" alt="商饮区域地图">
