...
<header class="header03">
  <div class="header-inner">
    <a class="header-logo" href="<?php echo APP_URL_EN ?>"><img src="<?php echo createSVG(175, 55); ?>" data-src="<?php echo APP_ASSETS ?>img/common/logo.svg" rel="js-lazy" width="175" height="55" alt="logo"></a>
    <nav class="header-info">
      <ul class="header-menu pc js-header-menu-drop">
        <li class="has-sub">
          <a class="menu-link c-txt-hover" href="<?php echo APP_URL_EN ?>guide/">
            <span class="txt-wrap">
              <span class="txt-default">Facilities</span>
              <span class="txt-on">Facilities</span>
            </span>
          </a>
          <div class="header-mega">
            <ul class="menu-list">
              <li><a href="<?php echo APP_URL_EN ?>guide/spa/">Sand SPA</a></li>
              <li><a href="<?php echo APP_URL_EN ?>guide/shop/">Shops</a></li>
              <li><a href="<?php echo APP_URL_EN ?>guide/restaurant/">Restaurant</a></li>
              <li><a href="<?php echo APP_URL_EN ?>guide/ishinoya/">Cottages</a></li>
            </ul>
          </div>
        </li>
        <li>
          <a class="menu-link c-txt-hover" href="<?php echo APP_URL_EN ?>ways/">
            <span class="txt-wrap">
              <span class="txt-default">Ways to Enjoy</span>
              <span class="txt-on">Ways to Enjoy</span>
            </span>
          </a>
        </li>
        <li>
          <a class="menu-link c-txt-hover" href="<?php echo APP_URL_EN ?>news/">
            <span class="txt-wrap">
              <span class="txt-default">News</span>
              <span class="txt-on">News</span>
            </span>
          </a>
        </li>
        <li>
          <a class="menu-link c-txt-hover" href="<?php if ($thisPageName != 'info') {
            ...
            <span class="txt-wrap">
              <span class="txt-default">Access</span>
              <span class="txt-on">Access</span>
            </span>
          </a>
        </li>
      ...
      <a class="header-btn c-txt-hover pc" href="https://www.asoview.com/channel/tickets/KfG8g2DPlR/" target="_blank" rel="noopener nofollow">
        <span class="txt-wrap">
          <span class="txt-default">Sand SPA Reservation</span>
          <span class="txt-on">Sand SPA Reservation</span>
        </span>
      </a>
        ...
        <div class="navigation-inner">
          ...
          <div class="navigation-row">
            <ul class="navigation-menu fs">
              <li class="is-col01"><a href="<?php echo APP_URL_EN ?>guide/">Facilities</a></li>
              <li class="is-col is-col01 is-order01"><a href="<?php echo APP_URL_EN ?>ways/">Ways to Enjoy</a></li>
              <li class="is-col02 is-order02"><a href="<?php echo APP_URL_EN ?>news/">News</a></li>
          ...
          <div class="navigation-row">
            <p class="navigation-ttl is-space pc">Official ACCOUNTS</p>
            ...
            <ul class="language-list sp">
              <li><a href="<?php echo APP_URL ?><?php echo $curr_path; ?>">日本語</a></li>
              <li class="language-txt"><a class="is-active" href="<?php echo APP_URL_EN ?><?php echo $curr_path; ?>">English</a></li>
              <li><a href="<?php echo APP_URL_KO ?><?php echo $curr_path; ?>">한국어</a></li>
              <li><a href="<?php echo APP_URL_CN ?><?php echo $curr_path; ?>">中文簡体</a></li>
            </ul>
          </div>
