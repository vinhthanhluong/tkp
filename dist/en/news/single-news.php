...
$titlepage = $sg_title_strip . '｜News & Events｜SHONIN PARK';
...
<body id="news-single" class="news-single en">
    ...
    <div class="article-news inner1170">
      ...
      <div class="article-block">
        ...
        if (isset($ids[$thisindex + 1])) {
          ...
          $prev_link = insertLangInUrl($prev_link, 'news', 'en');
          $prev_ttl = get_field('title_en', $previd) ?: get_the_title($previd);
        ...
        if (isset($ids[$thisindex - 1])) {
          ...
          $next_link = insertLangInUrl($next_link, 'news', 'en');
          $next_ttl = get_field('title_en', $nextid) ?: get_the_title($nextid);
