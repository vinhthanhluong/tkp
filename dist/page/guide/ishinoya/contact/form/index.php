    ...
    <div class="sec-form">
      <div class="inner1170">
        ...
        <div class="form-step">
          ...
          <img class="sp" src="<?php echo createSVG(327, 88) ?>" data-src="<?php echo APP_ASSETS; ?>img/ishinoya/contact/form/img_step01_sp.png" rel="js-lazy" width="327" height="88" alt="内容入力">
        </div>
