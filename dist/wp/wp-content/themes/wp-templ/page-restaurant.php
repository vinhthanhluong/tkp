  ...
  <main id="wrap">
    ...
    <section class="c-about-block">
      ...
      <div class="about-right">
        <div class="about-content dot-decor">
          <p class="about-desc aos-init" data-aos="fade-up">別府湾を一望する絶好のロケーションで、本格ハワイアングリルをベースに、大分風にアレンジしたお料理を楽しめるレストラン「Grill Takka」。<br>ポキボウルやオニオンブロッサムなどの定番メニューに加え、地元食材を活かしたオリジナルメニューもご用意しています。<br>海風と陽気なハワイの雰囲気に包まれながら、特別なひとときをお過ごしください。</p>
    ...
    <div class="sec-grill">
      ...
      <div class="grill-data aos-init" data-aos="fade-up">
        ...
        <dl>
          <dt>ご予約</dt>
          <dd>ご予約は<a class="txt-link" href="https://yoyaku.tabelog.com/yoyaku/net_booking_form/index?rcd=44014354" target="_blank" rel="noopener nofollow">こちら</a></dd>
        </dl>
        <dl>
          <dt>TEL</dt>
