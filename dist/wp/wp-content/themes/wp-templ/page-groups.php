    ...
    <div class="sec-group">
      <div class="inner1170">
        ...
        <div class="sc4">
          ...
          <div class="sc5">
            <h5>スーペリア</h5>
            <p>対象客室：スーペリアツイン（クイーンベッド2台）／スーペリアトリプル（セミダブルベッド3台）／スーペリアバンクフォース（クイーンベッド2台＋シングルベッド2台）</p>
            <table class="utbl-gr">
              <thead>
                <tr>
                  <th>料金ランク</th>
          ...
          <div class="sc5">
            ...
            <p class="note">
              ※ サービス料金・消費税込み。入湯税（お1人様1泊あたり250円）は別途。<br>
              ※ お一人様あたりのご料金が税別50,001円以上の場合は一泊につき入湯税500円となります。<br>
              ※ Sand SPA の砂湯体験は含まれません。大浴場はご利用いただけます。
            </p>
          </div>
        </div>
        <div class="sc4">
          <h4>貸切プラン<span>1泊2食（宿泊コテージエリア全23室貸切）15:00～翌10:00</span></h4>
          <table class="utbl-gr">
            <thead>
              <tr>
                <th>料金ランク</th>
          ...
          <p class="note">
            ※ 24名様以上のご利用の際は1名様追加につき+14,300円/名を頂戴いたします。<br>
            ※ 宿泊コテージエリアのみを貸切でご利用頂けます。<br>
            ※ 貸切プランは特別料金のため31名以上の違約金が適用されます。<br>
            ※ サービス料金・消費税込み。入湯税（お1人様1泊あたり250円）は別途。<br>
            ※ お一人様あたりのご料金が税別50,001円以上の場合は一泊につき入湯税500円となります。<br>
            ※ Sand SPA の砂湯体験は含まれません。大浴場はご利用いただけます。
          </p>
