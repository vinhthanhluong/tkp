...
<body id="event" class="event event-single page-single page-form form-thanks">
  <?php include(APP_PATH . "libs/header.php") ?>
  <main id="wrap">
    <div class="inner thanks-main">
      <picture>
        <source media="(max-width: 999px)" srcset="<?php echo APP_ASSETS ?>img/common/form/img_step03SP.svg" width="345" height="55">
        <img src="<?php echo createSVG(714, 45) ?>" data-src="<?php echo APP_ASSETS; ?>img/common/form/img_step03.svg" rel="js-lazy" width="714" height="45" alt="送信完了" class="step-img">
      </picture>
