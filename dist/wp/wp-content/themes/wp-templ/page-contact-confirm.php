...
$reg_address01    = (!empty($_POST['address01'])) ? sanitize_form_value($_POST['address01']) : '';
$reg_address02    = (!empty($_POST['address02'])) ? sanitize_form_value($_POST['address02']) : '';
$reg_pref_name    = (!empty($_POST['pref_name'])) ? sanitize_form_value($_POST['pref_name']) : '';
    ...
    <main id="wrap">
      <form method="post" class="confirmform" action="../complete/?g=<?php echo $gtime ?>" name="confirmform" id="confirmform">
        <div class="inner form-block">
          ...
          <img class="step-im sp" src="<?php echo createSVG(345, 55) ?>" data-src="<?php echo APP_ASSETS; ?>img/common/form/img_step02SP.svg" rel="js-lazy" width="345" height="55" alt="内容確認">
          <img class="step-img pc" src="<?php echo createSVG(714, 45) ?>" data-src="<?php echo APP_ASSETS; ?>img/common/form/img_step02.svg" rel="js-lazy" width="714" height="45" alt="内容確認">
