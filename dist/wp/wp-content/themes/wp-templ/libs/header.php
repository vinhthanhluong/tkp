...
<header id="header" class="header">
  <div class="inHeader">
    ...
    <div class="layerMenu">
      <div class="inLayer">
        <ul class="gNavi">
          <li class="gNavi-item"><a href="<?php echo APP_URL ?>"><span>施設案内</span></a></li>
          <li class="gNavi-item"><a href="<?php echo APP_URL ?>"><span>ニュース</span></a></li>
          <li class="gNavi-item"><a href="<?php echo APP_URL ?>"><span>楽しみ方</span></a></li>
          <li class="gNavi-item"><a href="<?php echo APP_URL ?>"><span>アクセス</span></a></li>
        </ul>
        <ul class="gNavi02">
          <li class="gNavi02-item"><a href="<?php echo APP_URL ?>"><span>営業時間</span></a></li>
          <li class="gNavi02-item"><a href="<?php echo APP_URL ?>"><span>採用情報</span></a></li>
          <li class="gNavi02-item"><a href="<?php echo APP_URL ?>"><span>周辺観光</span></a></li>
          <li class="gNavi02-item"><a href="<?php echo APP_URL ?>"><span>お問い合わせ</span></a></li>
          <li class="gNavi02-item"><a href="<?php echo APP_URL ?>"><span>よくあるご質問</span></a></li>
        </ul>
