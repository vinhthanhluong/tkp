...
<header class="header03">
  <div class="header-inner">
    <a class="header-logo" href="<?php echo APP_URL ?>"><img src="<?php echo createSVG(175, 55); ?>" data-src="<?php echo APP_ASSETS ?>img/common/logo.svg" rel="js-lazy" width="175" height="55" alt="logo"></a>
